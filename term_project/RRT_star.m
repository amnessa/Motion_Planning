function path = RRT_star(q_init, q_goal, O, r, dq, radius, beta, max_iter)
    ...
    % max_iter: Maximum number of iterations to search for a path
    ...
    for iter = 1:max_iter
        ...
        q_new = q_near + dq * (q_rand - q_near) / norm(q_rand - q_near); % Take a step towards the random point
